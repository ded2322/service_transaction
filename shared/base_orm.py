        ...
        async with async_session_maker() as session:
            try:
                ...
                if isinstance(e, SQLAlchemyError):
                    ...
                    print(f"SQLAlchemy exc in show database: {str(e)}")
                else:
                    #logger_error.error(f"Unknown exc in show database: {str(e)}")
                    print(f"Unknown exc in show database: {str(e)}")
        ...
        async with async_session_maker() as session:
            ...
            try:
                ...
                if isinstance(e, SQLAlchemyError):
                    ...
                    print(f"SQLAlchemy exc in found or none: {str(e)}")
                else:
                    #logger_error.error(f"Unknown exc in found or none: {str(e)}")
                    print(f"Unknown exc in found or none: {str(e)}")
        ...
        async with async_session_maker() as session:
            ...
            try:
                ...
                if isinstance(e, SQLAlchemyError):
                    ...
                    print(f"SQLAlchemy exc in found_data_by_id: {str(e)}")
                else:
                    #logger_error.error(f"Unknown exc un found_data_by_id: {str(e)}")
                    print(f"Unknown exc un found_data_by_id: {str(e)}")
        ...
        async with async_session_maker() as session:
            try:
                ...
                if isinstance(e, SQLAlchemyError):
                    ...
                    print(f"SQLAlchemy exc in update_data: {str(e)}")
                else:
                    #logger_error.error(f"Unknown exc in update_data: {str(e)}")
                    print(f"Unknown exc in update_data: {str(e)}")
        ...
        async with async_session_maker() as session:
            ...
            try:
                ...
                if isinstance(e, SQLAlchemyError):
                    ...
                    print(f"SQLAlchemy exc in delete_data: {str(e)}")
                else:
                    #logger_error.error(f"Unknown exc in delete_data: {str(e)}")
                    print(f"Unknown exc in delete_data: {str(e)}")
